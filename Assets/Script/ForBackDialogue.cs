...
public class ForBackDialogue : MonoBehaviour
{
    ...
    [SerializeField] private BackDialogue[] backDialogue;
    ...
    private void NextDialogue()
    {
        ...
        txt_Dialogue.text = backDialogue[count].dialogue;
        txt_Name.text = backDialogue[count].name;
        sprite_Left.sprite = backDialogue[count].CG_left;
        sprite_Right.sprite = backDialogue[count].CG_right;
        sprite_DialogueBox.sprite = backDialogue[count].dialogueBox;
        count++;
